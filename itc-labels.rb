...
LABELS = [
  ...
  {:label => 'Queue +5', :color => 'D3CBAA', :description => 'Queue +5'},
  {:label => 'Queue +4', :color => 'D3CBAA', :description => 'Queue +4'},
  {:label => 'Queue +3', :color => 'D3CBAA', :description => 'Queue +3'},
  {:label => 'Queue +2', :color => 'D3CBAA', :description => 'Queue +2'},
  {:label => 'Queue +1', :color => 'D3CBAA', :description => 'Queue +1'},
  {:label => 'Agreement +3', :color => 'D3CBAA', :description => 'Maintenance priority +3'},
